...
storiesOf("Appointment", module)
  ...
  .add("Error Deleting", () => <ErrorDeleting message="Could not delete appointment"
    onClose={action("onClose")}
  />)
  .add("Error Saving", () => <ErrorSaving message="Could not save appointment"
    onClose={action("onClose")}
  />)
  .add("Status saving", () => <Saving message="Saving"/>)
